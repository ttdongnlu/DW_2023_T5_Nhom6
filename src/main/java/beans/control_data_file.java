...
public class control_data_file {
    ...
    public control_data_file(int id, control_data_file_config control_data_file, LocalDateTime file_timestamp, Date data_range, String note, LocalDateTime datecreate_at, String create_by, String stt) {
        this.id = id;
        this.control_data_file = control_data_file;
        this.file_timestamp = file_timestamp;
        this.data_range = data_range;
        this.note = note;
        this.datecreate_at = datecreate_at;
    ...
    public Date getData_range() {
        return data_range;
    }

    public void setData_range(Date data_range) {
        this.data_range = data_range;
    }
